...
ModularForecastWidget::ModularForecastWidget(ModularForecast *module)
{
    ...
    addInput(createInput<PJ301MPort>(Vec(18, 30), module, ModularForecast::CH_INPUTS + 0));
    addInput(createInput<PJ301MPort>(Vec(18, 60), module, ModularForecast::CH_INPUTS + 1));
    addInput(createInput<PJ301MPort>(Vec(18, 90), module, ModularForecast::CH_INPUTS + 2));
    addInput(createInput<PJ301MPort>(Vec(18, 120), module, ModularForecast::CH_INPUTS + 3));
    addInput(createInput<PJ301MPort>(Vec(18, 150), module, ModularForecast::CH_INPUTS + 4));
    addInput(createInput<PJ301MPort>(Vec(18, 180), module, ModularForecast::CH_INPUTS +5));
    addOutput(createOutput<PJ301MPort>(Vec(18, 210), module, ModularForecast::MIX_OUTPUT));
